...
public class Surround extends Module {
   ...
   public void onTick(ClientTickEvent event) {
      if (!this.nullCheck()) {
         if (this.finished && (this.disable.getEnumValue().equalsIgnoreCase("WhenDone") || this.disable.getEnumValue().equalsIgnoreCase("OnLeave") && !this.mc.field_71439_g.field_70122_E)) {
            this.disable();
         }
         ...
         while(var3.hasNext()) {
            ...
            BlockPos pos = new BlockPos(position.func_178787_e(this.mc.field_71439_g.func_174791_d()));
