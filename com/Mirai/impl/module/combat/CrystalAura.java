...
public class CrystalAura extends Module {
   ...
   public void onUpdate(ClientTickEvent event) {
      Iterator var2 = this.mc.field_71441_e.field_72996_f.iterator();

      while(var2.hasNext()) {
         Entity entity = (Entity)var2.next();
         if (entity instanceof EntityEnderCrystal && !(entity.func_70032_d(this.mc.field_71439_g) > (float)this.Break.getIntegerValue())) {
