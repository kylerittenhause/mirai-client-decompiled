...
public class ModuleButton {
   ...
   public void render(int mX, int mY) {
      ...
      if (this.isHover(this.X, this.Y, this.W, this.H - 1, mX, mY) && this.module.getDescription() != null && !this.module.getDescription().equals("")) {
         FontUtil.drawStringWithShadow(this.module.getDescription(), 2.0D, (double)((new ScaledResolution(this.mc)).func_78328_b() - FontUtil.getFontHeight() - 2), (new Color(-221985596, true)).getRGB());
      }
