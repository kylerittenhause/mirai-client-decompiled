   ...
   private int find(MethodNode method, InjectionPoint injectionPoint, int defaultValue, String description) {
      if (injectionPoint == null) {
         ...
         if (nodes.size() != 1 && select == InjectionPoint.Selector.ONE) {
            ...
            return !result ? defaultValue : method.instructions.indexOf(select == InjectionPoint.Selector.FIRST ? (AbstractInsnNode)nodes.getFirst() : (AbstractInsnNode)nodes.getLast());
         }
      }
   }
